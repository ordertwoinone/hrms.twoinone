...
export type EmiratesId = Tbl["emirates_ids"]["Row"];
...
export interface EidDetail extends EidListItem {
  attachmentUrl: string | null;
  createdAt: string;
  updatedAt: string;
}

export interface EidFormOptions {
  employees: {
    id: string;
    name: string;
    code: string | null;
...
export interface EidDashboardData {
  total: number;
  active: number;
  expired: number;
