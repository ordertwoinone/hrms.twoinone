...
export const ROLE_PERMISSIONS: Record<Role, readonly Permission[]> = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.WPS_VIEW,
    PERMISSIONS.WPS_MANAGE,
    ...
    PERMISSIONS.EMIRATES_ID_VIEW,
    PERMISSIONS.EMIRATES_ID_MANAGE,
    PERMISSIONS.PASSPORT_VIEW,
    PERMISSIONS.PASSPORT_MANAGE,
    PERMISSIONS.LABOUR_CARD_VIEW,
    PERMISSIONS.LABOUR_CARD_MANAGE,
    PERMISSIONS.MEDICAL_INSURANCE_VIEW,
